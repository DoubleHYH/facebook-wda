...
if __name__ == '__main__':
    ...
    # print ">>2<<"
    # print els.displayed
    # print c(className = "Button", text = u"登录").displayed
    # for i in els.elements:
        # print i.keys()
    # print c.source().encode('utf-8')
    # print s(className = "Cell")[2].bounds
    # print s.alert.text
    # print s.alert.buttons()
    # for t in s(text = u"接单"):
        # print t.exists
    # print s(text = u"取消订单")[2].bounds
